...
export function Hero() {
    ...
    return (
        <section
            className="relative min-h-[50vh] md:min-h-[70vh] flex items-center pt-8 pb-16 md:py-0 overflow-hidden bg-[#0A001F]"
        >
                ...
                <div className="w-full mx-auto text-center space-y-4 sm:space-y-10">
                    ...
                    >
                        ...
                        <motion.p
                            ...
                            className="text-xs sm:text-sm text-white/60 font-medium max-w-2xl mx-auto px-6 leading-relaxed text-balance"
                        >
